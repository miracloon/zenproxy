...
pub fn router(state: Arc<AppState>) -> Router {
    ...
    let admin_routes = Router::new()
        ...
        .route("/api/admin/proxies/batch", post(admin::proxies::batch_proxy_action))
        .route("/api/admin/proxies/cleanup", post(admin::proxies::cleanup_proxies))
        .route("/api/admin/proxies/enable-valid", post(admin::proxies::batch_enable_valid))
        .route("/api/admin/proxies/disable-invalid", post(admin::proxies::batch_disable_invalid))
        .route("/api/admin/proxies/validate-disabled", post(admin::proxies::batch_validate_disabled))
        .route("/api/admin/proxies/validate-invalid", post(admin::proxies::batch_validate_invalid))
